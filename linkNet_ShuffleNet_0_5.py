from backbones.ShuffleNetv2 import *
...
class LinkNet(nn.Module):
    ...
    def __init__(self, n_classes=21, pretrained=False):
        ...
        self.backbone = shufflenetv2_0_5(pretrained=pretrained)

        self.decoder1 = Decoder(48, 24, 3, 2, 1, 1)
        self.decoder2 = Decoder(96, 48, 3, 2, 1, 1)
        self.decoder3 = Decoder(192, 96, 3, 2, 1, 1)
        self.decoder4 = Decoder(1024, 192, 3, 2, 1, 1)
